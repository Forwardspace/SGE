...
powershell -Command "(gc ScapeGameEngine\ScapeGameEngine.vcxproj) -replace '<PreprocessorDefinitions>%%', '<PreprocessorDefinitions>SGE_MAKE_LIB;%%' | Out-File ScapeGameEngine\ScapeGameEngine.vcxproj"